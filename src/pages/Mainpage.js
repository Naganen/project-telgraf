                ...
                <div className="bg-dark-subtle rounded-3 d-flex" style={{ width: "370px", height: "100%" }}>
                    <div className="bg-secondary-subtle rounded-3 d-flex flex-column p-3 justify-content-start align-items-center" style={{ width: "80px", height: "100%" }}>
                        ...
                        <div className="position-absolute bottom-0 m-4 d-flex flex-column">
                            <h3 onClick={() => setListType(0)} title="Arkadaşlar" className="btn btn-outline-secondary border-0 bg-transparent"><i className="fa-solid fa-user-group"></i></h3>
                            <h3 onClick={() => setListType(1)} title="Sunucular" className="btn btn-outline-secondary border-0 bg-transparent"><i className="fa-solid fa-globe"></i></h3>
                            <h3 onClick={() => setListType(2)} title="Bildirimler" className="btn btn-outline-secondary border-0 bg-transparent"><i className="fa-solid fa-bell"></i></h3>
                            <h3 title="Ayarlar" className="btn btn-outline-secondary border-0 bg-transparent"><i className="fa-solid fa-gear"></i></h3>
                    ...
                    <div className="rounded-3 d-flex flex-column justify-content-center align-items-start w-100">
                        <div className="flex-fill p-3 w-100">
                            {listType == 0 ? <FriendsList /> : listType == 1 ? <ServerList /> : <Notifications />}
                        </div>
